...
var style_Data_Devoir_Carte_Thematiquecheflieu_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_Data_Devoir_Carte_Thematiquecheflieu_3(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_Data_Devoir_Carte_Thematiquecheflieu_3rule0_eval_expression(context)) {
        ...
        var style = rules_Data_Devoir_Carte_Thematiquecheflieu_3(feature, value);
        ;
